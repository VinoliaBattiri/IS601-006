...
def purchase():
    ...
    try:
        ...
        order_id = -1
        if not has_error:
            ##UCID: vb437, Date May 5            address = request.form.get('apt') + "," + request.form.get('city') + "," + request.form.get('state') + "," + request.form.get('country') + "," + request.form.get('zpcode')
